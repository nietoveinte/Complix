 ...
 */
public class DialogoCalculadora extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        toolbar.setNavigationIcon(getResources().getDrawable(R.drawable.ic_arrow_back_dark));
        ...
        btn_done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (chainireal.toString().isEmpty() && chainimagi.equals("i")) {
                    comunicacion.setValor(textview,0, 1);
                    dismiss();
                }else
                if (chainireal.toString().isEmpty() && chainimagi.equals("-i")) {
                ...
                if (chainireal.toString().isEmpty() && chainimagi.length() > 0) {
                    chainimagi = chainimagi.substring(0, chainimagi.length()-1);
                    double imagi = convierteDouble(chainimagi);
                    comunicacion.setValor(textview, 0, imagi);
                    dismiss();
                }else


                if (chainimagi.equals("+i")) {
                    double real = convierteDouble(chainireal);
                    comunicacion.setValor(textview, real, 1);
                    dismiss();
                ...
                if (chainimagi.toString().isEmpty()) {
                    double real = convierteDouble(chainireal);
                    comunicacion.setValor(textview, real, 0);
                    dismiss();
                }else

                if (chainimagi.length() > 0) {
                    ...
                    if(chainimagi.substring(0,1).equals("+")){
                        ...
                        double imagi = convierteDouble(chainimagi);
                        double real = convierteDouble(chainireal);
                        comunicacion.setValor(textview,real,imagi);
                        dismiss();
...
//===================== SET ==============================================================================//
    ...
    public static void setContext(int textview2) {
